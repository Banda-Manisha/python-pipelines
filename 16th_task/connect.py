...
def load_aws_config(env_file=r'C:\Users\Manish\Desktop\unstructures2AWS\config\config.env'):
...
def read_config(file_path=r'C:\Users\Manish\Desktop\unstructures2AWS\config\config.ini'):
